        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('passenger-agents.update', $passenger_agent) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('agent_group') is-invalid @enderror"
                                    name="agent_group" id="agent_group"
                                    value="{{ old('agent_group') ?? $passenger_agent->agent_group }}">
                                @error('agent_group')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" id="name" value="{{ old('name') ?? $passenger_agent->name }}">
                                @error('name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('nid_no') is-invalid @enderror"
                                    name="nid_no" id="nid_no" value="{{ old('nid_no') ?? $passenger_agent->nid_no }}">
                                @error('nid_no')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('father_name') is-invalid @enderror"
                                    ...
                                    value="{{ old('father_name') ?? $passenger_agent->father_name }}">
                                @error('father_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('mother_name') is-invalid @enderror"
                                    ...
                                    value="{{ old('mother_name') ?? $passenger_agent->mother_name }}">
                                @error('mother_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('village_house') is-invalid @enderror"
                                    ...
                                    value="{{ old('village_house') ?? $passenger_agent->village_house }}">
                                @error('village_house')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('road_block_sector') ?? $passenger_agent->road_block_sector }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('country') is-invalid @enderror"
                                    ...
                                    value="{{ old('country') ?? $passenger_agent->country }}">
                                @error('country')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('division') is-invalid @enderror"
                                    ...
                                    value="{{ old('division') ?? $passenger_agent->division }}">
                                @error('division')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('district') is-invalid @enderror"
                                    ...
                                    value="{{ old('district') ?? $passenger_agent->district }}">
                                @error('district')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('police_station') ?? $passenger_agent->police_station }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" id="email"
                                    value="{{ old('email') ?? $passenger_agent->email }}">
                                @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('post_office') is-invalid @enderror"
                                    ...
                                    value="{{ old('post_office') ?? $passenger_agent->post_office }}">
                                @error('post_office')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('contact_no') is-invalid @enderror"
                                    ...
                                    value="{{ old('contact_no') ?? $passenger_agent->contact_no }}">
                                @error('contact_no')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('emergency_name_phone') ?? $passenger_agent->emergency_name_phone }}">
