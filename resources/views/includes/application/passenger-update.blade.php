...
<div class="row mb-3">
    <div class="col-md-4">
        ...
        <select class="form-control @error('agent') is-invalid @enderror" name="agent" id="agent" required>
            ...
            @foreach ($passenger_agents as $passenger_agent)
                @php
                    $isSelected = old('agent') == $passenger_agent->id || $passenger->agent == $passenger_agent->id;
                @endphp
                <option value="{{ $passenger_agent->id }}" @selected($isSelected)>{{ $passenger_agent->name }}
                </option>
            @endforeach
        </select>
        @error('agent')
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('passenger_name') is-invalid @enderror" name="passenger_name"
            id="passenger_name" value="{{ old('passenger_name') ?? $passenger->passenger_name }}" required>
    ...
    <div class="col-md-4">
        ...
        <input type="number" class="form-control @error('nid_no') is-invalid @enderror" name="nid_no" id="nid_no"
            value="{{ old('nid_no') ?? $passenger->nid_no }}">
        @error('nid_no')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
...
<div class="row mb-3">
    <div class="col-md-4">
        ...
        <select class="form-control @error('gender') is-invalid @enderror" name="gender" id="gender" required>
            ...
            @foreach ($genders as $gender)
                @php
                    $isSelected = old('gender') == $gender->value || $passenger->gender->value == $gender->value;
                @endphp
    ...
    <div class="col-md-4">
        ...
        <input type="date" class="form-control @error('dob') is-invalid @enderror" name="dob" id="dob"
            value="{{ old('dob') ?? $passenger->dob }}" required>
        @error('dob')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('father_name') is-invalid @enderror" name="father_name"
            id="father_name" value="{{ old('father_name') ?? $passenger->father_name }}" required>
        @error('father_name')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
...
<div class="row mb-3">
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('mother_name') is-invalid @enderror" name="mother_name"
            id="mother_name" value="{{ old('mother_name') ?? $passenger->mother_name }}" required>
        @error('mother_name')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('spouse_name') is-invalid @enderror" name="spouse_name"
            id="spouse_name" value="{{ old('spouse_name') ?? $passenger->spouse_name }}">
        @error('spouse_name')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <select class="form-control @error('religion') is-invalid @enderror" name="religion" id="religion" required>
            ...
            @foreach ($religions as $religion)
                @php
                    $isSelected =
                        old('religion') == $religion->value || $passenger->religion->value == $religion->value;
                @endphp
                <option value="{{ $religion->value }}" @selected($isSelected)>
    ...
    <div class="col-md-4">
        ...
        <select class="form-control @error('marital_status') is-invalid @enderror" name="marital_status"
            ...
            @foreach ($marital_statuses as $marital_status)
                @php
                    $isSelected =
                        old('marital_status') == $marital_status->value ||
                        $passenger->marital_status->value == $marital_status->value;
                @endphp
                <option value="{{ $marital_status->value }}" @selected($isSelected)>
    ...
    <div class="col-md-4">
        ...
        <select class="form-control @error('passenger_type') is-invalid @enderror" name="passenger_type"
            ...
            @foreach ($passenger_types as $passenger_type)
                @php
                    $isSelected =
                        old('passenger_type') == $passenger_type->value ||
                        $passenger_type->value == $passenger->passenger_type->value;
                @endphp
                <option value="{{ $passenger_type->value }}" @selected($isSelected)>
...
<div class="row mb-3">
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('village_house') is-invalid @enderror" name="village_house"
            id="village_house" value="{{ old('village_house') ?? $passenger->village_house }}">
        @error('village_house')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <select name="division_id" id="division_id" class="form-control @error('division_id') is-invalid @enderror"
            ...
            @foreach ($divisions as $division)
                @php
                    $isSelected = old('division_id') == $division->id || $passenger->division_id == $division->id;
                @endphp
    ...
    <div class="col-md-4">
        ...
        <select name="district_id" id="district_id" class="form-control @error('district_id') is-invalid @enderror"
            ...
            @foreach ($dist as $dis)
                @php
                    $isSelected = old('district_id') == $dis->id || $passenger->district_id == $dis->id;
                @endphp
                <option value="{{ $dis->id }}" @selected($isSelected)>{{ $dis->name }}</option>
            @endforeach
        </select>
        @error('district_id')
            <span class="text-danger">{{ $message }}</span>
...
<div class="row mb-3">
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('police_station') is-invalid @enderror"
            ...
            value="{{ old('police_station') ?? $passenger->police_station }}" required>
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('post_office') is-invalid @enderror" name="post_office"
            id="post_office" value="{{ old('post_office') ?? $passenger->post_office }}">
        @error('post_office')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <input type="number" class="form-control @error('contact_no') is-invalid @enderror" name="contact_no"
            id="contact_no" value="{{ old('contact_no') ?? $passenger->contact_no }}" required>
        @error('contact_no')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
...
<div class="row mb-3">
            ...
            @foreach ($current_statuses as $current_status)
                @php
                    $isSelected =
                        ...
                        $passenger->current_status->value == $current_status->value;
                @endphp
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('emergency_name_contact') is-invalid @enderror"
            name="emergency_name_contact" id="emergency_name_contact"
            value="{{ old('emergency_name_contact') ?? $passenger->emergency_name_contact }}">
    ...
    <div class="col-md-4">
        ...
        <select name="recruiting_agent" id="recruiting_agent"
            ...
            @foreach ($service_agents as $service_agent)
                @php
                    $isSelected =
                        old('recruiting_agent') == $service_agent->id ||
                        $passenger->recruiting_agent == $service_agent->id;
                @endphp
                <option value="{{ $service_agent->id }}" @selected($isSelected)>{{ $service_agent->name }}
                </option>
            @endforeach
        </select>
